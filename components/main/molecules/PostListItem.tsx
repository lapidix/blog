...
const PostListItem = ({ post, author, index }: PostListItemProps) => {
  ...
  return (
    <Link
      href={href}
      className="group flex items-center gap-2 p-2 transition-all duration-300 hover:bg-zinc-100/90 dark:hover:bg-zinc-700"
    >
      {/* 썸네일 */}
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-xs font-semibold text-zinc-900 dark:text-zinc-100 line-clamp-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-200">
