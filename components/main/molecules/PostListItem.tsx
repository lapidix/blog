...
const PostListItem = ({ post, author, index }: PostListItemProps) => {
  ...
  return (
    <Link
      href={href}
      className="group flex items-center gap-4 p-2 transition-all duration-300 hover:bg-slate-100 dark:hover:bg-slate-800/50"
    >
      {/* 썸네일 */}
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
