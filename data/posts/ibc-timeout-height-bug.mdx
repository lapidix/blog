...
<figure className="flex flex-col items-center justify-center">
  ...
  <figcaption className="text-center text-sm text-gray-300 mt-2">정상 트랜잭션</figcaption>
</figure>

<figure className="flex flex-col items-center justify-center">
  <img src="/static/images/ibc-timeout-height-bug/abnormal-tx.png" alt="IBC 개요" />
  <figcaption className="text-center text-sm text-gray-300 mt-2">비 정상 트랜잭션</figcaption>
</figure>

여기서 `Packet Timeout Height`를 확인하면 이상하다는 것을 알 수 있습니다.  
