...
date: '2025-08-14'
lastmod: '2025-08-14'
tags: ['Frontend', 'TailwindCSS', 'Emotion', 'JIT', 'CSS-in-JS', 'CSS', 'React']
draft: false
summary:
...
Emotion에서는 런타임 CSS-in-JS의 진화된 설계를 볼 수 있었습니다. 단순 CSS-in-JS뿐만 아니라 SSR 하이드레이션 지원 등이 조합되어 런타임임에도 불구하고 실용적인 성능을 달성하는 방식은 인상 깊었습니다.
